<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
  ...
  <xsl:template name="buildTable">
    ...
    <xsl:param name="newMeter"><xsl:value-of select="//Interaction/Checklist/VerifiedMeter/@OptionValue" /></xsl:param>
    ...
    <xsl:if test="count($listRows) > 0">
      <xsl:for-each select="$listRows">
        <xsl:choose>
          ...
          <xsl:when test="$headerOnly = 0 and name()='VerifiedMeter'"></xsl:when>		<!-- handled above by setting a newMeter parameter -->
          <!-- ================================================================================================================================ -->
          <xsl:when test="$headerOnly = 0 and name()='TelemetryMeasuringDevice'">
            <tr height="24px" style="page-break-inside:avoid; vertical-align:center; border-left:solid 1px {$backColor}; border-right:solid 1px {$backColor};">
              ...
              <td style="page-break-inside:avoid; font-size: 10pt;">
				<xsl:value-of select="//Interaction/Checklist/TelemetryDataMeasuringDevice"/><span style="font-weight:bold; color:#007DA5;"><xsl:choose><xsl:when test="contains($newMeter,'New')"> NEW METER</xsl:when><xsl:otherwise /></xsl:choose></span>
              </td>
            </tr>
		  </xsl:when>
          <!-- ================================================================================================================================ -->
          <xsl:when test="$headerOnly = 0 and name()='TelemetryMeasuringDeviceSerial'">
            <tr height="24px" style="page-break-inside:avoid; vertical-align:center; border-left:solid 1px {$backColor}; border-right:solid 1px {$backColor};">
              <td style="page-break-inside:avoid; text-indent: 20px; font-size: 10pt;">
                <xsl:call-template name="label" />
              </td>
              <td style="page-break-inside:avoid; font-size: 10pt;">
				<xsl:value-of select="//Interaction/Checklist/TelemetryMeasuringDeviceSerial"/>
              </td>
            </tr>
		  </xsl:when>
          <!-- ================================================================================================================================ -->
          <xsl:when test="$headerOnly = 0 and name()='TelemetryDataMeasuringDevice'">
            <tr height="24px" style="page-break-inside:avoid; vertical-align:center; border-left:solid 1px {$backColor}; border-right:solid 1px {$backColor};">
              <td style="page-break-inside:avoid; text-indent: 20px; font-size: 10pt;">
                <xsl:call-template name="label" />
              </td>
          ...
          <!-- ================================================================================================================================ -->
          <xsl:when test="$headerOnly = 0 and name()='TelemetryDataMeasuringDeviceSerial'">
            <tr height="24px" style="page-break-inside:avoid; vertical-align:center; border-left:solid 1px {$backColor}; border-right:solid 1px {$backColor};">
              <td style="page-break-inside:avoid; text-indent: 20px; font-size: 10pt;">
                <xsl:call-template name="label" />
              </td>
              <td style="page-break-inside:avoid; font-size: 10pt;">
				<xsl:value-of select="//Interaction/Checklist/TelemetryDataMeasuringDeviceSerial"/>
              </td>
            </tr>
		  </xsl:when>
          <!-- ================================================================================================================================ -->
